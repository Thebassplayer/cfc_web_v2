    ...
    <section className="grid h-full grid-rows-3 p-4 lg:flex lg:flex-col lg:px-28 lg:py-7">
      ...
      <div className="row-span-2 row-start-2 flex flex-col justify-evenly py-2 lg:flex lg:flex-row lg:justify-center">
        <div className="flex flex-col justify-evenly lg:block lg:w-1/3 lg:px-4">
          <Image src={IconOne} alt="Icono 1" className="mx-auto mb-8" />
        ...
        <div className="flex flex-col justify-evenly lg:block lg:w-1/3 lg:px-4">
          <Image src={Icontwo} alt="Icono 2" className="mx-auto mb-8" />
          <h1 className="text-center font-bebas text-2xl leading-none text-purple-light lg:pb-4">
        ...
        <div className="flex flex-col justify-evenly lg:block lg:w-1/3 lg:px-4">
          <Image src={IconThree} alt="Icono 3" className="mx-auto mb-8" />
          <h1 className="text-center font-bebas text-2xl leading-none text-purple-light lg:pb-4">
